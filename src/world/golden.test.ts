...
const GOLDEN: Record<number, Record<string, string>> = {
  1: { graph: 'cee2dffc', hydro: '008cbfe6', structures: 'f428fc67', chunks: '3b4f149c', quests: '07c8c2d8' },
  2: { graph: 'e006116b', hydro: '7fa41781', structures: 'b9e90d86', chunks: 'f7bb9f69', quests: '2fa87fd6' },
};
