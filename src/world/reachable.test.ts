...
const EXPLAINED = new Map<string, string>([
  ...
  ['src/world/highland.ts: Uplands', 'graph.test.fixture preserves the retired bounded-country invariant'],
  ...
  ['src/world/mesh.ts: generateMesh', 'mesh.test and ranges.test preserve the retired bounded-country fixture'],
