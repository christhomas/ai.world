 ...
 */
export type AnchorKind = 'island' | 'dungeon';
...
const KIND_SALT: Record<AnchorKind, number> = { island: SALT.ISLAND, dungeon: SALT.DUNGEON };

/** Current generator version per kind; bump when a generator changes so old anchors stay pinned. */
export const ANCHOR_VERSION: Record<AnchorKind, number> = { island: 1, dungeon: 1 };
