 ...
 *
 * Moved here from `highland.ts` when the bounded country it smoothed retired with #192: this is
 * the one place left that still asks it, preserving the invariant rather than the runtime path.
 */
