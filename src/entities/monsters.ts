 ...
 *
 * The numbers that decide how a fight goes are in `properties/monsters.json`, with the argument
 * for each of them beside it. The numbers in the part lists are not: they are a shape, and a
 * shape is read by looking at it rather than by being told.
 */
