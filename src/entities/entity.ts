...
/*
 * And the same for getting about, which moved out to `walking.ts` when this file got too long to
 * hold in your head. Re-exported rather than repointed at forty call sites: where a step is worked
 * out is this file's business and not theirs, and the two halves are one subject.
 */
export {
  bodyBox, bodyOf, canStand, groundY, spaceNear, tryMove, anybodyAt, SWEEP,
  type Crowd,
} from './walking';
