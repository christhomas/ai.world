...
export const LONG_RUN: Record<string, LongRun> = {
  ...
  /*
   * A woodcutter's day is hours like a miner's: out to the trees at first light, home at dusk.
   *
   ...
   *
   * And, as with the woodcutter and the miner, what a week of his *work* comes to is not this form's
