...
export const SHOP_DEFS: Record<ShopType, ShopDef> = {
  store: {
    ...
    items: ['apple', 'bread', 'wheatseed', 'turnipseed', 'pumpkinseed', 'tunic', 'boots', 'stick', 'rope', 'lantern', 'map', 'rod', 'shovel', 'saw', 'firerocks', 'knife', 'tent', 'glider'],
  ...
  smith: {
    ...
    items: ['sword', 'steelsword', 'axe', 'bow', 'arrow', 'cap', 'helm', 'jerkin', 'mail', 'plate', 'shield', 'ironshield', 'greaves'],
