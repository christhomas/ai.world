...
export interface Probed {
  ...
  /**
   * The world's creatures as this page has them: how far behind it is drawing them, and the
   * nearest one that measurement is about.
   *
   * Handed over whole rather than as two closures, because the two answers only mean anything
